...
class MovieForm (forms.ModelForm) :
    ...
    class Meta :
        ...
        widgets = {
                ...
                'runtime' : forms.TextInput(attrs={'class' : 'form-control','type' : 'time'}),
    ...
    def clean(self):
        ...
        # extention = os.path.splitext(photo.name)[1].lower()

        # if extention not in ['.jpg','.jpeg','.png'] :

        #     self.add_error('photo','upload file with extensions jpg or jpeg or png')
