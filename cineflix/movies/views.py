...
from . models import Movie,IndustryChoices,GenreChoice,ArtistsChoioces,LanguageChoices,CertificationChoice
...
#         artists_choices = ArtistsChoioces
...
class MovieCreateView(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        messages.error(request,'Movie created successfully.')
